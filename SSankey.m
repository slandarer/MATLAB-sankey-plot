        ...
        function setLabelLocation(obj, layer, location)
            ...
            for n = find(obj.Layer == layer).'
                ...
                switch obj.LabelLocation{n}
                    case 'right',set(obj.LabelHdl(n),'Position',[tLayerPos(n,2),mean(tLayerPos(n,[3,4]))],'HorizontalAlignment','left','VerticalAlignment','middle');
                    case 'left',set(obj.LabelHdl(n),'Position',[tLayerPos(n,1),mean(tLayerPos(n,[3,4]))],'HorizontalAlignment','right','VerticalAlignment','middle');
                    case 'top',set(obj.LabelHdl(n),'Position',[mean(tLayerPos(n,[1,2])),tLayerPos(n,3)],'HorizontalAlignment','center','VerticalAlignment','bottom');
                    case 'center',set(obj.LabelHdl(n),'Position',[mean(tLayerPos(n,[1,2])),mean(tLayerPos(n,[3,4]))],'HorizontalAlignment','center','VerticalAlignment','middle');
                    case 'bottom',set(obj.LabelHdl(n),'Position',[mean(tLayerPos(n,[1,2])),tLayerPos(n,4)],'HorizontalAlignment','center','VerticalAlignment','top');
                end
            end
        end
    end
